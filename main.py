...
class BillGenerator:
    def __init__(self, master):
        ...
        self.btn_search = tk.Button(
            master, text="Search", width=12, bg="orange", command=self.search
        )
        ...
        self.quantity_label = tk.Label(
            master, text="Enter Quantity:", font=self.font_style
        )
        ...
        # Add to bill button
        self.btn_add_to_bill = tk.Button(
            master,
            text="Add to Bill",
            width=15,
            bg="steelblue",
        ...
        self.bill_box = tk.Text(
            master, width=60, height=18, wrap=tk.WORD, font=self.font_style
        )
        ...
        self.total_label = tk.Label(
            master, text="", font=("Arial", 18, "bold"), fg="green"
        )
        self.total_label.grid(row=7, column=0, columnspan=3, pady=5)

        # Print Bill button
        self.btn_print_bill = tk.Button(
            master,
            text="Print Bill",
            width=15,
            bg="green",
        ...
        self.inventory_scrollbar = tk.Scrollbar(
            self.inventory_frame, orient=tk.VERTICAL, command=self.inventory_tree.yview
        )
    ...
    def create_menu(self):
        ...
        file_menu.add_command(
            label="Add to Database", command=self.open_add_to_database
        )
        file_menu.add_command(
            label="Update Database", command=self.open_update_database
        )
    ...
    def open_add_to_database(self):
        ...
        subprocess.Popen(
            [
                "python",
                "C:\\Users\\Abhir\\OneDrive\\Desktop\\java\\Inventory Management\\add_to_db.py",
            ]
        )
    ...
    def open_update_database(self):
        ...
        subprocess.Popen(
            [
                "python",
                "C:\\Users\\Abhir\\OneDrive\\Desktop\\java\\Inventory Management\\update.py",
            ]
        )
    ...
    def add_to_bill(self):
        ...
        try:
            ...
            if quantity > self.product_stock:
                ...
                mycursor.execute(
                    "INSERT INTO transaction (product_name, quantity, amount, date) VALUES (%s, %s, %s, %s)",
